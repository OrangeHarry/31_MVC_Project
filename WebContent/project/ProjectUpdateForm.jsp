	...
	<form action="update.do" method="post">
		<ul>
			...
			<li>
				...
				<input type="text" id="startDate" name="startDate" placeholder="예)2021-01-01" value="${project.startDate }">
			</li>
			<li>
				<label for="endDate">종료일</label>
				<input type="text" id="endDate" name="endDate" placeholder="예)2021-01-01" value="${project.endDate }">
			</li>
			<li>
		...
		<input type="button" value="삭제" onclick="location.href='delete.do?=${project.no}'">
